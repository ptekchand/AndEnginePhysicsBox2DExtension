...
JNIEXPORT jlong JNICALL Java_com_badlogic_gdx_physics_box2d_World_jniCreateBuoyancyController(JNIEnv* env, jobject object, jlong addr, jfloat normalX, jfloat normalY, jfloat offset, jfloat density, jfloat velocityX, jfloat velocityY, jfloat linearDrag, jfloat angularDrag, jboolean useDensity, jboolean useWorldGravity, jfloat gravityX, jfloat gravityY) {
...
JNIEXPORT void JNICALL Java_com_badlogic_gdx_physics_box2d_World_jniDestroyController(JNIEnv* env, jobject object, jlong addr, jlong controllerAddr) {
